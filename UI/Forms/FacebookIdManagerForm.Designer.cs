...
partial class FacebookIdManagerForm
{
    ...
    private void InitializeComponent()
    {
        ...
        olvColBulkCompanyName = new BrightIdeasSoftware.OLVColumn();
        ...
        grpProfileInfo.Controls.Add(lblCompanyName);
        grpProfileInfo.Controls.Add(txtCompanyName);
        grpProfileInfo.Controls.Add(lblCompanyType);
        grpProfileInfo.Controls.Add(txtCompanyType);
        grpProfileInfo.Controls.Add(lblPageType);
        grpProfileInfo.Controls.Add(txtPageType);
        ...
        grpProfileInfo.Size = new Size(521, 210);
        ...
        progressBar.Size = new Size(490, 18);
        ...
        grpBulkImport.Location = new Point(12, 281);
        ...
        olvBulkList.Columns.AddRange(new ColumnHeader[] { olvColBulkUsername, olvColBulkCompanyName, olvColBulkStatus });
        ...
        MinimizeBox = false;
        MinimumSize = new Size(561, 646);
        Name = "FacebookIdManagerForm";
        ShowInTaskbar = false;
        StartPosition = FormStartPosition.CenterParent;
        Text = "Facebook Page Manager";
    ...
    private Label lblPageType;
    private TextBox txtPageType;
    ...
    private BrightIdeasSoftware.OLVColumn olvColBulkCompanyName;
